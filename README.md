# ProjectDescription
This project is created using [Google Adk](https://adk.dev/) and uses a [Sequential Agent](https://adk.dev/agents/workflow-agents/sequential-agents/) approach to first gather information from web using search agent and then translate the information into ppt for consumption
